...
Source0  : https://github.com/libratbag/libratbag/archive/v0.10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565997713
...
cp COPYING %{buildroot}/usr/share/package-licenses/libratbag/COPYING
DESTDIR=%{buildroot} ninja -C builddir install
## install_append content
pushd %{buildroot}/usr/share/libratbag
mv "logitech-g9x-[Call-of-Duty-MW3-Edition].device" "logitech-g9x-Call-of-Duty-MW3-Edition.device"
mv "logitech-g9x-[Original].device" "logitech-g9x-Original.device"
popd
## install_append end
...
/usr/share/package-licenses/libratbag/COPYING
