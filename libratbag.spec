...
%prep
%setup -q -n libratbag-0.14
cd %{_builddir}/libratbag-0.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599070932
...
cp %{_builddir}/libratbag-0.14/COPYING %{buildroot}/usr/share/package-licenses/libratbag/ad46f9be2737903a5706c4b1e313d72883bce6d1
