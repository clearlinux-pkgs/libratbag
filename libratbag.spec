...
Requires: libratbag-python = %{version}-%{release}
Requires: libratbag-python3 = %{version}-%{release}
...
%package python
Summary: python components for the libratbag package.
Group: Default
Requires: libratbag-python3 = %{version}-%{release}

%description python
python components for the libratbag package.


%package python3
Summary: python3 components for the libratbag package.
Group: Default
Requires: python3-core

%description python3
python3 components for the libratbag package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727212448
